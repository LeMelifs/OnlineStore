<template>
  <q-header reveal class="bg-transparent text-black " height-hint="98" >
    <q-toolbar>
      <q-btn  flat rounded label="Категории" no-caps class="q-ml-md " style="font-weight: bold"></q-btn>
      <q-btn  flat rounded label="О нас" no-caps class="q-ml-md " style="font-weight: bold"></q-btn>
      <q-toolbar-title>
        <router-link to="/main">
