<template>
  <q-header reveal class="bg-transparent text-black " height-hint="98" >
    <q-toolbar>
      <q-btn  flat dense rounded label="Категории" no-caps class="q-ml-md " style="font-weight: bold"></q-btn>
      <q-btn  flat dense rounded label="О нас" no-caps class="q-ml-lg " style="font-weight: bold"></q-btn>
      <q-toolbar-title>
        <router-link to="/">
      ...
      <q-btn flat rounded dense icon="account_circle"  no-caps class="q-mr-lg  " style="font-weight: bold"></q-btn>
      </router-link>
       <router-link v-else to="/login" style="color: #1D1D1D">
      <q-btn flat rounded dense icon="account_circle"  no-caps class="q-mr-lg  " style="font-weight: bold"></q-btn>
      </router-link>
    </q-toolbar>
